...
!0));if(!(b instanceof a&&b.length))throw"Missing or invalid $view.";if(d&&"object"!==typeof d)throw"Invalid properties.";b=b.first();c=b.data("props")||{};var g=d||{};d=a.extend({},this.settings.defaultProps,c,g);b.data("props",d);a.each(d.viewAttrs,function(a,c){"src"!==a.toLowerCase()&&b.attr(a,c)});if("undefined"===typeof c.url||c.url!==d.url){var h=function(){return 1===Number(b.data("urlCounter"))},l=function(c){c=void 0===c?!0:c;var d=e.$parentObj._.$tabz.eq(e.mapViewIndex(b,c));if(c&&!(d instanceof
