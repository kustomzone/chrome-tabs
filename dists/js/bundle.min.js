...
g,m){(function(d,a){if("function"===typeof define&&define.amd)define(["jquery","draggabilly/draggabilly"],function(c,f){return a(d,c,f)});else if("object"===typeof g&&g.exports){var l=d.jQuery||h("jquery"),m=d.Draggabilly||h("draggabilly");g.exports=a(d,l,m)}else a(d,jQuery,Draggabilly)})(window,function(d,a,g){var h=-1,c=function(b){this.defaultSettings={obj:".chrome-tabz",minWidth:45,maxWidth:243,leftMargin:0,rightMargin:300,overlapDistance:14,viewz:"iframes",allowDragNDrop:!0,allowDoubleClick:!0,
initial:[],defaultProps:{url:"https://duckduckgo.com/?kae=b&kak=-1&kao=-1&k1=-1&kt=p&kj=f5f5f5&ka=p&kf=1&kam=google-maps&km=l&ko=1",title:"New Tab",favicon:"default",loadingFavicon:"loading",unknownUrlTitle:"Web Page",viewAttrs:{}},debug:!1};if(b&&"object"!==typeof b)throw"`settings` is not an object.";this.settings=a.extend(!0,{},this.defaultSettings,b||{});if(-1===a.inArray(typeof this.settings.obj,["string","object"]))throw"`obj` must be a string selector, jQuery, or an element in the DOM.";if(1!==
(this.$obj=a(this.settings.obj).first()).length)throw"Unable to locate a single `obj` in the DOM.";if("number"!==typeof this.settings.minWidth||isNaN(this.settings.minWidth))throw"`minWidth` is not a number.";if("number"!==typeof this.settings.maxWidth||isNaN(this.settings.maxWidth))throw"`maxWidth` is not a number.";if("number"!==typeof this.settings.leftMargin||isNaN(this.settings.leftMargin))throw"`leftMargin` is not a number.";if("number"!==typeof this.settings.rightMargin||isNaN(this.settings.rightMargin))throw"`rightMargin` is not a number.";
if("number"!==typeof this.settings.overlapDistance||isNaN(this.settings.overlapDistance))throw"`overlapDistance` is not a number.";if(-1===a.inArray(this.settings.viewz,["","iframes","webviews"]))throw"`viewz` must be: iframes, webviews, or an empty string.";if("boolean"!==typeof this.settings.allowDragNDrop)throw"`allowDragNDrop` is not a boolean.";if("boolean"!==typeof this.settings.allowDoubleClick)throw"`allowDoubleClick` is not a boolean.";if(this.settings.initial instanceof Array){if("object"!==
typeof this.settings.defaultProps)throw"`defaultProps` is not an object.";if(-1===a.inArray(typeof this.settings.debug,["number","boolean"]))throw"`debug` is not a number or boolean.";}else throw"`initial` is not an array.";this.settings.minWidth=Math.max(1,this.settings.minWidth);this.settings.maxWidth=Math.max(1,this.settings.maxWidth);this.settings.rightMargin=Math.max(0,this.settings.rightMargin);this.settings.overlapDistance=Math.max(0,this.settings.overlapDistance);this.$obj.data("chromeTabz",
this);this.$bar=a('<div class="-bar"></div>');this.$content=a('<div class="-content"></div>');this.$bottomLine=a('<div class="-bottom-line"></div>');this.$viewz=a('<div class="-viewz"></div>');this.$styles=a("<style></style>");this.id=++h;this.draggabillyInstances=[];this.alwaysOnStyles=".chrome-tabz.-id-"+this.id+" > .-bar > .-content {\n        margin-left: "+this.settings.leftMargin+"px;\n        width: calc(100% - "+this.settings.rightMargin+"px);\n      }";this.$obj.trigger("constructed",[this]);
this.initialize()};c.prototype.initialize=function(){this.addClasses();this.addBar();this.addContent();this.addBottomLine();this.addStyles();this.addViewz();this.addEvents();this.configureLayout();this.fixStackingOrder();this.addDraggabilly();this.settings.initial.length&&this.addTabz(this.settings.initial);this.$obj.trigger("initialized",[this])};c.prototype.destroy=function(){this.removeDraggabilly();this.$tabz.remove();this.removeEvents();this.removeViewz();this.removeStyles();this.removeBottomLine();
this.removeContent();this.removeBar();this.removeClasses();this.$obj.removeData("chromeTabz");this.$obj.trigger("destroyed",[this]);this.$obj.off(".chrome-tabz")};c.prototype.addClasses=function(){this.$obj.addClass("chrome-tabz");this.$obj.addClass("-id-"+this.id)};c.prototype.removeClasses=function(){this.$obj.removeClass("chrome-tabz");this.$obj.removeClass("-id-"+this.id)};c.prototype.addBar=function(){this.$obj.append(this.$bar)};c.prototype.removeBar=function(){this.$bar.remove()};c.prototype.addContent=
function(){this.$bar.append(this.$content)};c.prototype.removeContent=function(){this.$content.remove()};c.prototype.addBottomLine=function(){this.$bar.append(this.$bottomLine)};c.prototype.removeBottomLine=function(){this.$bottomLine.remove()};c.prototype.addStyles=function(){this.$bar.append(this.$styles);this.$styles.html(this.alwaysOnStyles)};c.prototype.removeStyles=function(){this.$styles.remove()};c.prototype.addViewz=function(){this.settings.viewz&&(this.$obj.append(this.$viewz),new f(a.extend({},
...
c.hasClass("-tab")?b.setCurrentTab(c):c.hasClass("-favicon")?b.setCurrentTab(c.parent(".-tab")):c.hasClass("-title")?b.setCurrentTab(c.parent(".-tab")):c.hasClass("-close")&&b.removeTab(c.parent(".-tab"))})};c.prototype.removeEvents=function(){a(d).off(".chrome-tabz.id-"+this.id);this.$obj.off(".chrome-tabz")};c.prototype.configureLayout=function(){var b=this;this.$tabz.width(this.tabWidth);this.settings.allowDragNDrop&&(this.$tabz.removeClass("-just-dragged"),this.$tabz.removeClass("-currently-dragged"));
requestAnimationFrame(function(){var c="";a.each(b.tabPositions,function(a,e){c+=".chrome-tabz.-id-"+b.id+" > .-bar > .-content > .-tab:nth-child("+(a+1)+") {\n            transform: translate3d("+e+"px, 0, 0);\n          }"});b.$styles.html(b.alwaysOnStyles+c)})};c.prototype.fixStackingOrder=function(){var b=this,c=this.$tabz.length;this.$tabz.each(function(e,d){d=a(d);e=c-e;d.hasClass("-current")&&(e=c+2,b.$bottomLine.css({zindex:c+1}));d.css({zindex:e})})};c.prototype.addDraggabilly=function(){var b=
this;this.settings.allowDragNDrop&&(this.removeDraggabilly(),this.$tabz.each(function(c,d){var e=a(d),k=b.tabPositions[c];c=new g(e[0],{axis:"x",containment:b.$content});b.draggabillyInstances.push(c);c.on("dragStart",function(){b.$tabz.removeClass("-just-dragged");b.$tabz.removeClass("-currently-dragged");b.fixStackingOrder();b.$bar.addClass("-dragging");e.addClass("-currently-dragged");b.$obj.trigger("tabDragStarted",[e,b])});c.on("dragMove",function(a,c,d){a=b.$tabz;c=e.index();var f=b.effectiveTabWidth;
d=Math.floor((k+d.x+f/2)/f);d=Math.max(0,Math.min(Math.max(0,a.length-1),d));c!==d&&(e[d<c?"insertBefore":"insertAfter"](a.eq(d)),b.$obj.trigger("tabDragMoved",[e,{prevIndex:c,newIndex:d},b]))});c.on("dragEnd",function(){var a=parseFloat(e.css("left"),10);e.css({transform:"translate3d(0, 0, 0)"});requestAnimationFrame(function(){e.css({left:0,transform:"translate3d("+a+"px, 0, 0)"});requestAnimationFrame(function(){e.addClass("-just-dragged");e.removeClass("-currently-dragged");setTimeout(function(){return e.removeClass("-just-dragged")},
500);b.setCurrentTab(e);requestAnimationFrame(function(){b.addDraggabilly();e.css({transform:""});b.$bar.removeClass("-dragging");b.$obj.trigger("tabDragStopped",[e,e.index(),b])})})})})}))};c.prototype.removeDraggabilly=function(){this.settings.allowDragNDrop&&(a.each(this.draggabillyInstances,function(a,c){return c.destroy()}),this.draggabillyInstances=[])};c.prototype.addTab=function(a,c){return this.addTabz([a],void 0===c?!0:c)};c.prototype.addTabz=function(b,c){c=void 0===c?!0:c;var e=this,d=
a();if(!(b instanceof Array&&b.length))throw"Missing or invalid property sets.";a.each(b,function(b,c){if(c&&"object"!==typeof c)throw"Invalid properties.";var k=a('\n    <div class="-tab">\n      <div class="-background">\n        <svg version="1.1" xmlns="http://www.w3.org/2000/svg">\n          <defs>\n            <symbol id="topleft" viewBox="0 0 214 29">\n              <path d="M14.3 0.1L214 0.1 214 29 0 29C0 29 12.2 2.6 13.2 1.1 14.3-0.4 14.3 0.1 14.3 0.1Z" />\n            </symbol>\n            <symbol id="topright" viewBox="0 0 214 29">\n              <use xlink:href="#topleft" />\n            </symbol>\n            <clipPath id="crop">\n              <rect class="mask" width="100%" height="100%" x="0" />\n            </clipPath>\n          </defs>\n          <svg width="50%" height="100%" transfrom="scale(-1, 1)">\n            <use xlink:href="#topleft" width="214" height="29" class="-background" />\n            <use xlink:href="#topleft" width="214" height="29" class="-shadow" />\n          </svg>\n          <g transform="scale(-1, 1)">\n            <svg width="50%" height="100%" x="-100%" y="0">\n              <use xlink:href="#topright" width="214" height="29" class="-background" />\n              <use xlink:href="#topright" width="214" height="29" class="-shadow" />\n            </svg>\n          </g>\n        </svg>\n      </div>\n      <div class="-favicon"></div>\n      <div class="-title"></div>\n      <div class="-close"></div>\n    </div>\n  ');
...
b.each(function(b,e){b=a(e);b.hasClass("-current")&&(b.prev(".-tab").length?c.setCurrentTab(b.prev(".-tab")):b.next(".-tab").length?c.setCurrentTab(b.next(".-tab")):c.setCurrentTab(void 0));c.$obj.trigger("tabBeingRemoved",[b,c]);b.remove();c.$obj.trigger("tabRemoved",[b,c])});this.configureLayout();this.fixStackingOrder();this.addDraggabilly()};c.prototype.updateTab=function(b,c,d){if(!(b instanceof a&&b.length))throw"Missing or invalid $tab.";if(c&&"object"!==typeof c)throw"Invalid properties.";
b=b.first();var e=b.data("props")||{},f=c||{};c=a.extend({},this.settings.defaultProps,e,f);b.data("props",c);b.find(".-title").text(c.title);c.favicon?"loading"===c.favicon?b.find(".-favicon").css({"background-image":""}).attr("data-favicon","loading"):"default"===c.favicon?b.find(".-favicon").css({"background-image":""}).attr("data-favicon","default"):b.find(".-favicon").css({"background-image":"url('"+c.favicon+"')"}).attr("data-favicon",""):b.find(".-favicon").css({"background-image":"none"}).attr("data-favicon",
"");this.$obj.trigger("tabUpdated",[b,c,d,e,f,this])};c.prototype.setCurrentTab=function(b){if(b&&!(b instanceof a&&b.length))throw"Missing or invalid $tab.";b=b?b.first():a();this.$tabz.removeClass("-current");b.addClass("-current");this.fixStackingOrder();this.$obj.trigger("currentTabChanged",[b,this])};$jscomp.global.Object.defineProperties(c.prototype,{$tabz:{configurable:!0,enumerable:!0,get:function(){return this.$content.find("> .-tab")}},$currentTab:{configurable:!0,enumerable:!0,get:function(){return this.$tabz.filter(".-current")}},
tabWidth:{configurable:!0,enumerable:!0,get:function(){var a=this.$content.innerWidth()-this.settings.overlapDistance,a=a/this.$tabz.length+this.settings.overlapDistance;return Math.max(this.settings.minWidth,Math.min(this.settings.maxWidth,a))}},effectiveTabWidth:{configurable:!0,enumerable:!0,get:function(){return this.tabWidth-this.settings.overlapDistance}},tabPositions:{configurable:!0,enumerable:!0,get:function(){var a=[],c=0,d=this.effectiveTabWidth;this.$tabz.each(function(b,e){a.push(c);
c+=d});return a}}});var f=function(b){this.defaultSettings={parentObj:".chrome-tabz",type:"iframes",defaultProps:{url:"https://duckduckgo.com/?kae=b&kak=-1&kao=-1&k1=-1&kt=p&kj=f5f5f5&ka=p&kf=1&kam=google-maps&km=l&ko=1",title:"New Tab",favicon:"default",loadingFavicon:"loading",unknownUrlTitle:"Web Page",viewAttrs:{}},debug:!1};if(b&&"object"!==typeof b)throw"`settings` is not an object.";this.settings=a.extend(!0,{},this.defaultSettings,b||{});if(-1===a.inArray(typeof this.settings.parentObj,["string",
"object"]))throw"`parentObj` must be a string selector, jQuery, or an element in the DOM.";if(1!==(this.$parentObj=a(this.settings.parentObj).first()).length)throw"Unable to locate a single `parentObj` in the DOM.";if((this.$parentObj._=this.$parentObj.data("chromeTabz"))instanceof c){if(1!==(this.$obj=this.$parentObj.find("> .-viewz")).length)throw"Unable to locate a single `> .-viewz` object in the DOM.";if(-1===a.inArray(this.settings.type,["iframes","webviews"]))throw"`type` must be one of: `iframes` or `webviews`.";
if("object"!==typeof this.settings.defaultProps)throw"`defaultProps` is not an object.";if(-1===a.inArray(typeof this.settings.debug,["number","boolean"]))throw"`debug` is not a number or boolean.";}else throw"Unable to locate a `chromeTabz` instance in the `parentObj`.";this.$obj.data("chromeTabViewz",this);this.viewIndex=[];this.$content=a('<div class="-content"></div>');this.$obj.trigger("constructed",[this]);this.initialize()};f.prototype.initialize=function(){this.addContent();this.addEvents();
this.$obj.trigger("initialized",[this])};f.prototype.destroy=function(){this.$viewz.remove();this.removeEvents();this.removeContent();this.$obj.removeData("chromeTabViewz");this.$obj.trigger("destroyed",[this]);this.$obj.off(".chrome-tabz")};f.prototype.addContent=function(){this.$obj.append(this.$content)};f.prototype.removeContent=function(){this.$content.remove()};f.prototype.addEvents=function(){var a=this;this.$parentObj.on("tabAdded.chrome-tabz",function(b,c){return a.addView(c)});this.$parentObj.on("tabBeingRemoved.chrome-tabz",
function(b,c){return a.removeView(void 0,c)});this.$parentObj.on("tabDragMoved.chrome-tabz",function(b,c,d){return a.setViewIndex(void 0,d.prevIndex,d.newIndex)});this.$parentObj.on("tabUpdated.chrome-tabz",function(b,c,d,f){return a.updateView(void 0,c,d,f)});this.$parentObj.on("currentTabChanged.chrome-tabz",function(b,c){return a.setCurrentView(void 0,c)})};f.prototype.removeEvents=function(){this.$parentObj.off(".chrome-tabz")};f.prototype.addView=function(b){if(!(b instanceof a&&b.length))throw"Missing or invalid $tab.";
b=b.first();var c=a("webviews"===this.settings.type?'\n    <webview class="-view"></webview>\n  ':'\n    <iframe class="-view" sandbox="allow-scripts allow-same-origin allow-forms allow-modals allow-popups allow-popups-to-escape-sandbox allow-presentation allow-orientation-lock allow-pointer-lock"></iframe>\n  ');c.data("urlCounter",0);this.$content.append(c);this.setViewIndex(c,void 0,b.index());this.$obj.trigger("viewAdded",[c,this]);return c};f.prototype.removeView=function(b,c){!(b instanceof
a&&b.length)&&c instanceof a&&c.length&&(b=this.viewAtIndex(c.index(),!0));if(!(b instanceof a&&b.length))throw"Missing or invalid $view.";b=b.first();this.$obj.trigger("viewBeingRemoved",[b,this]);this.removeViewFromIndex(b);b.remove();this.$obj.trigger("viewRemoved",[b,this])};f.prototype.removeViewFromIndex=function(b){if(!(b instanceof a&&b.length))throw"Missing or invalid $view.";b=b.first();this.viewIndex.splice(this.mapViewIndex(b,!0),1)};f.prototype.viewAtIndex=function(b,c){if("number"!==
typeof b||isNaN(b)||0>b)throw"Missing or invalid index.";b=this.viewIndex[b]||void 0;if(c&&!(b instanceof a&&b.length))throw"No $view with that index.";return b instanceof a&&b.length?b.first():void 0};f.prototype.mapViewIndex=function(b,c){if(!(b instanceof a&&b.length))throw"Missing or invalid $view.";b=b.first();for(var d=0;d<this.viewIndex.length;d++)if(this.viewIndex[d].is(b))return d;if(c)throw"$view not in the index.";return-1};f.prototype.setViewIndex=function(b,c,d){b instanceof a&&b.length||
void 0===c||(b=this.viewAtIndex(c,!0));if(!(b instanceof a&&b.length))throw"Missing or invalid $view.";if("number"!==typeof d||isNaN(d)||0>d)throw"Missing or invalid newIndex.";b=b.first();-1!==(c=this.mapViewIndex(b))&&this.viewIndex.splice(c,1);this.viewIndex.splice(d,0,b);this.$obj.trigger("viewIndexed",[b,{prevIndex:c,newIndex:d},this])};f.prototype.updateView=function(b,c,d,f){var e=this;if("view::state-change"!==f){!(b instanceof a&&b.length)&&c instanceof a&&c.length&&(b=this.viewAtIndex(c.index(),
!0));if(!(b instanceof a&&b.length))throw"Missing or invalid $view.";if(d&&"object"!==typeof d)throw"Invalid properties.";b=b.first();c=b.data("props")||{};var g=d||{};d=a.extend({},this.settings.defaultProps,c,g);b.data("props",d);a.each(d.viewAttrs,function(a,c){"src"!==a.toLowerCase()&&b.attr(a,null===c?"":c)});if("undefined"===typeof c.url||c.url!==d.url){var h=function(){return 1===Number(b.data("urlCounter"))},l=function(c){c=void 0===c?!0:c;var d=e.$parentObj._.$tabz.eq(e.mapViewIndex(b,c));
if(c&&!(d instanceof a&&d.length))throw"Missing $tab.";return d};if("webviews"===this.settings.type){var k="";b.off("did-start-loading.chrome-tabz").on("did-start-loading.chrome-tabz",function(a){a=l();var c=b.data("props");b.data("urlCounter",b.data("urlCounter")+1);var d=c.loadingFavicon,f="function"===typeof b.getTitle?b.getTitle():"",f=!f&&h()?c.url||c.title:f;e.$parentObj._.updateTab(a,{favicon:d,title:f?f:"..."},"view::state-change");e.$obj.trigger("viewStartedLoading",[b,e])});b.off("did-stop-loading.chrome-tabz").on("did-stop-loading.chrome-tabz",
function(a){a=l();var c=b.data("props"),c=(c=!k&&h()?c.favicon:k)?c:e.settings.defaultProps.favicon;e.$parentObj._.updateTab(a,{favicon:c},"view::state-change");e.$obj.trigger("viewStoppedLoading",[b,e])});b.off("page-favicon-updated.chrome-tabz").on("page-favicon-updated.chrome-tabz",function(a){var c=l(),d=b.data("props");k=a.originalEvent.favicons.length?a.originalEvent.favicons[0]:"";a=(a=!k&&h()?d.favicon:k)?a:e.settings.defaultProps.favicon;"function"!==typeof b.isLoading||b.isLoading()||e.$parentObj._.updateTab(c,
{favicon:a},"view::state-change");e.$obj.trigger("viewFaviconUpdated",[b,a,e])});b.off("page-title-updated.chrome-tabz").on("page-title-updated.chrome-tabz",function(a){var c=l();b.data("props");a=(a=(a=a.originalEvent.title||"")||"function"!==typeof b.getURL?a:b.getURL())?a:e.settings.defaultProps.unknownUrlTitle;e.$parentObj._.updateTab(c,{title:a},"view::state-change");e.$obj.trigger("viewTitleUpdated",[b,a,e])})}else{var m=a(b[0].contentWindow),n;m.off("unload.chrome-tabz").on("unload.chrome-tabz",
n=function(c){c=l(!1);var d=b.data("props");if(c instanceof a&&c.length&&a.contains(document,c[0])&&d&&a.contains(document,b[0])){b.data("urlCounter",b.data("urlCounter")+1);var f=d.loadingFavicon,g=h()?d.url:"",g=!g&&h()?d.title:g;e.$parentObj._.updateTab(c,{favicon:f,title:g?g:"..."},"view::state-change");e.$obj.trigger("viewStartedLoading",[b,e])}});b.off("load.chrome-tabz").on("load.chrome-tabz",function(c){c=l();var d=b.data("props");try{m.off("unload.chrome-tabz").on("unload.chrome-tabz",n)}catch(r){}var f;
a:{try{f=b.contents().prop("URL");break a}catch(r){}f=void 0}f=f||"";f=!f&&h()?d.url:f;var g;a:{try{g=a.trim(b.contents().find('head > link[rel="shortcut icon"]').prop("href"));break a}catch(r){}g=void 0}g=g||"";g=!g&&h()?d.favicon:g;g=(g=!g&&f?f.replace(/^(https?:\/\/[^\/]+).*$/i,"$1")+"/favicon.ico":g)?g:e.settings.defaultProps.favicon;var k;a:{try{k=a.trim(b.contents().find("head > title").text());break a}catch(r){}k=void 0}k=k||"";k=(k=(k=!k&&h()?d.title:k)?k:f)?k:e.settings.defaultProps.unknownUrlTitle;
e.$parentObj._.updateTab(c,{favicon:g,title:k},"view::state-change");e.$obj.trigger("viewFaviconUpdated",[b,g,e]);e.$obj.trigger("viewTitleUpdated",[b,k,e]);e.$obj.trigger("viewStoppedLoading",[b,e])})}b.attr("src",d.url)}this.$obj.trigger("viewUpdated",[b,d,f,c,g,this])}};f.prototype.setCurrentView=function(b,c){!(b instanceof a&&b.length)&&c instanceof a&&c.length&&(b=this.viewAtIndex(c.index(),!0));if(b&&!(b instanceof a&&b.length))throw"Missing or invalid $view.";b=b?b.first():a();this.$viewz.removeClass("-current");
b.addClass("-current");this.$obj.trigger("currentViewChanged",[b,this])};$jscomp.global.Object.defineProperties(f.prototype,{$viewz:{configurable:!0,enumerable:!0,get:function(){return this.$content.find("> .-view")}},$currentView:{configurable:!0,enumerable:!0,get:function(){return this.$viewz.filter(".-current")}}});a.fn.chromeTabz=function(b){return this.each(function(d,f){a(f).data("chromeTabz")||new c(a.extend({},b||{},{obj:f}))})};return a.fn.chromeTabz})},{draggabilly:1,jquery:void 0}]},{},
[6]);})();
