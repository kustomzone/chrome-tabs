...
"");b.find("> .-title").text(c.title);b.find("> .-close")[c.allowClose?"show":"hide"]();this.$obj.trigger("tabUpdated",[b,c,d,e,f,this])};c.prototype.setCurrentTab=function(b){if(b&&!(b instanceof a&&b.length))throw"Missing or invalid $tab.";b=b?b.first():a();this.$tabz.removeClass("-current");b.addClass("-current");this.fixStackingOrder();this.$obj.trigger("currentTabChanged",[b,this])};$jscomp.global.Object.defineProperties(c.prototype,{$tabz:{configurable:!0,enumerable:!0,get:function(){return this.$content.find("> .-tab")}},
$currentTab:{configurable:!0,enumerable:!0,get:function(){return this.$tabz.filter(".-current")}},tabWidth:{configurable:!0,enumerable:!0,get:function(){var a=this.$content.innerWidth()-this.settings.overlapDistance,a=a/this.$tabz.length+this.settings.overlapDistance;return Math.max(this.settings.minWidth,Math.min(this.settings.maxWidth,a))}},effectiveTabWidth:{configurable:!0,enumerable:!0,get:function(){return this.tabWidth-this.settings.overlapDistance}},tabPositions:{configurable:!0,enumerable:!0,
get:function(){var a=[],c=0,d=this.effectiveTabWidth;this.$tabz.each(function(b,e){a.push(c);c+=d});return a}}});var f=function(b){this.defaultSettings={parentObj:".chrome-tabz",type:"iframes",defaultProps:{url:"https://duckduckgo.com/?kae=b&kak=-1&kao=-1&k1=-1&kt=p&kj=f5f5f5&ka=p&kf=1&kam=google-maps&km=l&ko=1",title:"New Tab",favicon:"default",loadingFavicon:"loading",unknownUrlTitle:"Web Page",allowClose:!0,viewAttrs:{}},debug:!1};if(b&&"object"!==typeof b)throw"`settings` is not an object.";this.settings=
